          ...
          {navLinks.map((link) => (
            ...
            >
              <a 
                ...
                // FIX: Changed from `&&` to a ternary operator. The `&&` operator could result in a boolean `false`
                // being passed to `onClick`, which is not a valid event handler and causes a TypeScript error.
                // The ternary operator ensures that either the function or `undefined` is passed.
        ...
        <main className="main-content" id="main-content" tabIndex={-1}>
          <section className="service-hero-section">
            <div className="container">
              <h1>Engineering <strong>Consultancy</strong></h1>
            </div>
          </section>
